...
In Homeworld Gaius, characters/NPCs have two similar storage mechanisms for determining
...
2. Skills - These are abilities that give characters/NPCs/etc new action
            options. Examples include skill-based abilities such as
            melee combat, climbing, lockpicking, crafting. Other types of
            skills are unlockable prerequisite mutations such as flight or
            psionic abilities.
